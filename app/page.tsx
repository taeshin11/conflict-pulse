        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-8">
            <div className="flex-1">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight mb-4 leading-tight">Conflict Pulse</h1>
              <p className="text-slate-300 text-base sm:text-lg max-w-2xl leading-relaxed">A live pulse of every active armed conflict. Click any country for full briefing.</p>
            </div>
