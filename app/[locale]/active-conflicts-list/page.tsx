...
export default async function ActiveConflictsListPage({ params }: { params: Promise<{ locale: string }> }) {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 flex-1">
        ...
        <div className="space-y-3">
          {sorted.map((c, i) => (
            <Link key={c.id} href={`/country/${c.slug}` as any} className="block bg-white rounded-2xl border border-slate-100 shadow-sm p-4 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group">
              <div className="flex items-center gap-3">
